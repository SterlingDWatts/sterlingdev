...
const BrandsPostreSql = ({ backgroundColor, fill, height }: Props) => {
  const svgProps: { height?: string } = {};
  if (height) svgProps.height = height;

  const pathProps = { fill: fill || "#000000", backgroundColor: backgroundColor || "#ffffff" };

  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 497 512" xmlSpace="preserve" {...svgProps}>
      <g
        id="orginal"
        style={{ fillRule: "nonzero", clipRule: "nonzero", stroke: pathProps.fill, strokeMiterlimit: 4 }}
      ></g>
      <g
        id="Layer_x0020_3"
        style={{
          ...
          clipRule: "nonzero",
          fill: "none",
          stroke: pathProps.backgroundColor,
          strokeWidth: 12.4651,
          strokeLinecap: "round",
      ...
      >
        ...
        <path
          style={{
            fill: pathProps.backgroundColor,
            strokeWidth: 4.155,
            strokeLinecap: "butt",
            strokeLinejoin: "miter",
          }}
...
export default BrandsPostreSql;
